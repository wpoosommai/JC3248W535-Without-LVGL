/*
  ============================================================================
  Program    : HelloWorld_DisplayTest_V1.5.1.ino
  Version    : V1.5.1
  Updated    : 2026-03-28 17:25 ICT
...
// หมายเหตุ: บางเวอร์ชันของ Arduino_GFX_Library ไม่มีชื่อสีสำเร็จรูป
// จึงกำหนดเองเพื่อป้องกัน error เช่น RED / GREEN / BLUE not declared
// =========================
